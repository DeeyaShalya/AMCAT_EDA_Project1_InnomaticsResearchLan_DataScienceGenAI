...
Welcome to the AMCAT Exploratory Data Analysis (EDA) project! 

This project dives deep into analyzing the AMCAT dataset to understand its hidden patterns and trends, enabling business stakeholders to gain actionable insights. The EDA process involves cleaning the data, exploring it visually, and drawing meaningful conclusions.
